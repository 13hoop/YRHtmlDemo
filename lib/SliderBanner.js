define(['jquery'], function ($) {
    ...
    _SliderBanner.prototype.initElement = function () {
        ...
        // "background": "#9a9a9a"
        // create css class in header
        // var htmlStr = "<style>" +
        //                 ".bottomDiv .indicatorCell {" +
        //                 "background : #9a9a9a;" +
        //                 "}" +
        //                 ".bottomDiv .indicatorCell.selected {" +
        //                 "background : red;" +
        //                 "}" +
        //                 "</style>"
        // $(window).find('header').append(htmlStr)
    ...
    _SliderBanner.prototype.play = function (mgl) {
        ...
        $out.stop(true, true).animate({
            ...
            var indicatorCells = $out.closest('.wrapView').find('.indicator .indicatorCell')
    ...
    return {
        banner: function($target, width, isAuto, callback) {
